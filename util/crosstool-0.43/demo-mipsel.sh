...
#eval `cat mipsel.dat gcc-3.2.3-glibc-2.3.2.dat` sh all.sh --notest
#eval `cat mipsel.dat gcc-3.3.6-glibc-2.2.5.dat` sh all.sh --notest
#eval `cat mipsel.dat gcc-3.3.6-glibc-2.3.2.dat` sh all.sh --notest
#eval `cat mipsel.dat gcc-3.3.6-glibc-2.3.2-tls.dat` sh all.sh --notest
#eval `cat mipsel.dat gcc-3.3.6-glibc-2.3.5.dat` sh all.sh --notest
#eval `cat mipsel.dat gcc-3.3.6-glibc-2.3.6.dat` sh all.sh --notest
