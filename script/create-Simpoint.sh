...
#simpoint directory
simpoint_dir=/home/cuihongwei/SimPoint.3.2
...
gem5_output_dir=/home/cuihongwei/gem5/simpoint
...
/home/cuihongwei/SimPoint.3.2/bin/simpoint -loadFVFile ${gem5_output_dir}/simpoint.bb.gz -maxK 30 -saveSimpoints $simpoint_file -saveSimpointWeights $weight_file -inputVectorsGzipped | tee -a $script_out
