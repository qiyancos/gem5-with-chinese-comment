...
# ****************************** gem5 parameters  ******************************
gem5_dir=/home/cuihongwei/server17/gem5-test
...
gem5_output_dir=/home/cuihongwei/gem5/checkpoint
gem5_args="--maxinsts=$max_inst --cpu-type=AtomicSimpleCPU \
...
#simpoint parameters
simpoint_dir=/home/cuihongwei/gem5/simpoint/$target/$ISA-$target-"input"$2
...
cp $spec_dir/benchspec/CPU2006/$target/data/all/input/* $run_dir
cp -r $spec_dir/benchspec/CPU2006/$target/run/run_base_ref_amd64.0001/* $run_dir
if [ $2 = "0" ]; then
	cp $spec_dir/benchspec/CPU2006/$target/data/test/input/* $run_dir
	cp $spec_dir/benchspec/CPU2006/$target/data/test/output/* $run_dir/standout
else
	cp $spec_dir/benchspec/CPU2006/$target/data/ref/input/* $run_dir
	cp $spec_dir/benchspec/CPU2006/$target/data/ref/output/* $run_dir/standout
fi
